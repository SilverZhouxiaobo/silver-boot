...
import cn.silver.framework.online.dao.OnlineDatasourceRelationMapper;
import cn.silver.framework.online.dao.OnlineDatasourceTableMapper;
import cn.silver.framework.online.dao.OnlinePageDatasourceMapper;
import cn.hb.software.gacim.online.domain.*;
import cn.silver.framework.online.service.OnlineDatasourceService;
import cn.silver.framework.online.service.OnlineTableService;
import cn.silver.framework.online.vo.SqlTable;
...
public abstract class OnlineDatasourceServiceImpl extends BaseServiceImpl<OnlineDatasourceMapper, OnlineDatasource> implements OnlineDatasourceService {
...
//    }
    ...
    public OnlineDatasource saveNew(OnlineDatasource onlineDatasource, SqlTable sqlTable, String pageId) {
        OnlineTable onlineTable = onlineTableService.saveNewFromSqlTable(sqlTable);
        onlineDatasource.setDatasourceId(IdUtil.randomUUID());
        ...
        datasourceTable.setId(IdUtil.randomUUID());
        ...
        onlinePageDatasource.setId(IdUtil.randomUUID());
...
//                this.createUpdateQueryForNullValue(onlineDatasource, onlineDatasource.getDatasourceId());
        return onlineDatasourceMapper.update(onlineDatasource) == 1;
    }
    ...
    public boolean remove(String datasourceId) {
        ...
        onlineDatasource.setDatasourceId(datasourceId);
        ...
        onlineDatasourceRelationMapper.deleteByPrimaryKey(datasourceId);
        // 开始删除多对多父表的关联
        OnlinePageDatasource onlinePageDatasource = new OnlinePageDatasource();
        ...
        List<OnlineDatasourceTable> datasourceTableList = onlineDatasourceTableMapper.selectList(filter);
        onlineDatasourceTableMapper.delete(filter);
     ...
     */
    @Override
    public List<OnlineDatasource> getOnlineDatasourceList(Set<String> datasourceIdSet) {
        return onlineDatasourceMapper.selectByIds(datasourceIdSet);
    }
...
//        this.buildRelationForDataList(resultList, MyRelationParam.normal(), batchSize);
     ...
     */
    @Override
    public List<OnlineDatasource> getNotInOnlineDatasourceListByPageId(String pageId, OnlineDatasource filter, String orderBy) {
...
//        this.buildRelationForDataList(resultList, MyRelationParam.dictOnly());
     ...
     */
    @Override
    public List<OnlineDatasource> getOnlineDatasourceListByPageId(String pageId, OnlineDatasource filter, String orderBy) {
        List<OnlineDatasource> resultList =
...
//        this.buildRelationForDataList(resultList, MyRelationParam.dictOnly());
     ...
     */
//    @Override
//    public List<OnlineDatasourceTable> getOnlineDatasourceTableList(Set<String> datasourceIdSet) {
//        datasourceIdSet.
//        return onlineDatasourceTableMapper.select(new QueryWrapper<OnlineDatasourceTable>()
...
//    }
     ...
     */
    @Override
    public List<OnlineDatasource> getOnlineDatasourceListByFormIds(Set<String> formIdSet) {
