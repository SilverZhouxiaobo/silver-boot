 ...
 * @date 2021-06-06
 */
public interface OnlinePageService extends IBaseService<OnlinePage> {
     ...
     */
    void updatePublished(String pageId, Boolean published);
     ...
     * @param pageId                   主表Id。
     */
    void addOnlinePageDatasourceList(List<OnlinePageDatasource> onlinePageDatasourceList, String pageId);
     ...
     * @return 中间表对象。
     */
    OnlinePageDatasource getOnlinePageDatasource(String pageId, String datasourceId);
     ...
     */
    List<OnlinePageDatasource> getOnlinePageDatasourceListByPageId(String pageId);
     ...
     * @return 使用该数据源的页面列表。
     */
    List<OnlinePage> getOnlinePageListByDatasourceId(String datasourceId);
     ...
     * @return 成功返回true，否则false。
     */
    boolean removeOnlinePageDatasource(String pageId, String datasourceId);
}
