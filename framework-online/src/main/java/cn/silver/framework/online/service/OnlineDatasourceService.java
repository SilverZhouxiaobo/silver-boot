 ...
 * @date 2021-06-06
 */
public interface OnlineDatasourceService extends IBaseService<OnlineDatasource> {
     ...
     * @return 返回新增对象。
     */
    OnlineDatasource saveNew(OnlineDatasource onlineDatasource, SqlTable sqlTable, String pageId);
     ...
     * @return 查询结果集。
     */
    List<OnlineDatasource> getOnlineDatasourceList(Set<String> datasourceIdSet);
     ...
     * @return 查询结果集。
     */
    List<OnlineDatasource> getNotInOnlineDatasourceListByPageId(String pageId, OnlineDatasource filter, String orderBy);
     ...
     * @return 查询结果集。
     */
    List<OnlineDatasource> getOnlineDatasourceListByPageId(String pageId, OnlineDatasource filter, String orderBy);
     ...
     */
//    List<OnlineDatasourceTable> getOnlineDatasourceTableList(Set<String> datasourceIdSet);
     ...
     */
    List<OnlineDatasource> getOnlineDatasourceListByFormIds(Set<String> readFormIdSet);
}
