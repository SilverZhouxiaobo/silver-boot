...
import cn.silver.framework.online.dao.OnlineDictMapper;
...
public class OnlineDictServiceImpl extends BaseServiceImpl<OnlineDictMapper, OnlineDict> implements OnlineDictService {
...
//    }
    ...
    public OnlineDict saveNew(OnlineDict onlineDict) {
        onlineDict.setDictId(IdUtil.randomUUID());
        Date now = new Date();
    ...
    public boolean update(OnlineDict onlineDict, OnlineDict originalOnlineDict) {
        ...
        return onlineDictMapper.update(onlineDict) == 1;
    }
    ...
    public boolean remove(String dictId) {
        return onlineDictMapper.deleteByPrimaryKey(dictId) == 1;
    }
     ...
     */
    @Override
    public List<OnlineDict> getOnlineDictList(Set<String> dictIdSet) {
        return onlineDictMapper.selectByIds(dictIdSet);
    }
...
//     */
//    @Override
//    public Response verifyRelatedData(OnlineDict onlineDict, OnlineDict originalOnlineDict) {
...
//            return Response.error(String.format(errorMessageFormat, "数据库链接主键id"));
//        }
