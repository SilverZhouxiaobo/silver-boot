 ...
 * @date 2021-06-06
 */
public interface OnlineTableService extends IBaseService<OnlineTable> {
     ...
     * @return 指定的数据表对象列表。
     */
    List<OnlineTable> getOnlineTableList(Set<String> tableIdSet);
     ...
     */
    List<OnlineTable> getOnlineTableListByDatasourceId(String datasourceId);
