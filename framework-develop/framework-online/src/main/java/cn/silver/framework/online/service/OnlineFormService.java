 ...
 * @date 2021-06-06
 */
public interface OnlineFormService extends IBaseService<OnlineForm> {
     ...
     * @return 返回新增对象。
     */
    OnlineForm saveNew(OnlineForm onlineForm, Set<String> datasourceIdSet);
     ...
     */
    boolean update(OnlineForm onlineForm, OnlineForm originalOnlineForm, Set<String> datasourceIdSet);
     ...
     * @return 删除数量。
     */
    int removeByPageId(String pageId);
     ...
     */
    List<OnlineFormDatasource> getFormDatasourceListByFormId(String formId);
     ...
     */
    List<OnlineForm> getOnlineFormListByDatasourceId(String datasourceId);
     ...
     * @return 在线表单集合。
     */
    List<OnlineForm> getOnlineFormListByPageIds(Set<String> pageIdSet);
}
