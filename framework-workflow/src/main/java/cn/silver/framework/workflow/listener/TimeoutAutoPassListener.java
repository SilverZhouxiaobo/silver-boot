...
@Slf4j
@Component
public class TimeoutAutoPassListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) {
        ...
        this.bussApi.approveFlow(workOrder.getTableName(), new ApproveModel(workOrder.getBusinessKey(), FlowApprovalType.AUTO_AGREE.getCode(), "处理超时，自动通过"));
    }
}
