...
public interface IFlowApiService {
     ...
     * @return 新启动的流程实例。
     */
    ProcessInstance start(String processDefinitionId, String dataId);

    ProcessInstance start(String processDefinitionId, String processDefinitionKey, String dataId);
    ...
    ProcessInstance startAndTakeFirst(
            String processDefinitionId, String dataId, FlowTaskComment flowTaskComment, JSONObject taskVariableData);
     ...
     * @return 调用结果。
     */
    void verifyAssigneeOrCandidateAndClaim(Task task);
     ...
     */
    PageInfo<HistoricProcessInstance> getHistoricProcessInstanceList(
     ...
     * @throws ParseException 日期参数解析失败。
     */
    PageInfo<HistoricTaskInstance> getHistoricTaskInstanceFinishedList(
            String processDefinitionName,
            String beginDate,
            String endDate,
            PageBean pageParam) throws ParseException;
     ...
     * @return 执行结果。
     */
    void stopProcessInstance(String processInstanceId, String stopReason, boolean forCancel);
     ...
     * @return 回退结果。
     */
    void backToRuntimeTask(Task task, String targetKey, boolean forReject, String reason);

    Set<String> buildGroupIdSet();
}
