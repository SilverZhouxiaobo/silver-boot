//package cn.hb.software.gacim.workflow.controller;
//
//import cn.hb.software.gacim.core.bean.Response;
//import cn.hb.software.gacim.core.bean.ResponseEnum;
//import cn.hb.software.gacim.workflow.constant.FlowApprovalType;
//import cn.hb.software.gacim.workflow.constant.FlowConstant;
//import cn.hb.software.gacim.workflow.constant.FlowMessageType;
//import cn.hb.software.gacim.workflow.constant.FlowTaskStatus;
//import cn.hb.software.gacim.workflow.domain.FlowEntry;
//import cn.hb.software.gacim.workflow.domain.FlowEntryPublish;
//import cn.hb.software.gacim.workflow.domain.FlowTaskComment;
//import cn.hb.software.gacim.workflow.domain.FlowWorkOrder;
//import cn.hb.software.gacim.workflow.exception.FlowOperationException;
//import cn.hb.software.gacim.workflow.service.IFlowApi;
//import cn.hb.software.gacim.workflow.service.IFlowEntryService;
//import cn.hb.software.gacim.workflow.service.IFlowMessageService;
//import cn.hb.software.gacim.workflow.service.IFlowWorkOrderService;
//import cn.hb.software.gacim.workflow.util.FlowOperationHelper;
//import cn.hb.software.gacim.workflow.vo.TaskInfoVo;
...
//    public Response<Void> startAndTakeUserTask(
//            @PathVariable("processDefinitionKey") String processDefinitionKey,
//            @RequestBody(required = true) FlowTaskComment flowTaskCommentDto,
//            @RequestBody JSONObject taskVariableData,
//            @RequestBody(required = true) JSONObject masterData,
//            @RequestBody JSONObject slaveData,
//            @RequestBody JSONObject copyData) {
//        String errorMessage;
//        // 1. 验证流程数据的合法性。
//        Response<FlowEntry> flowEntryResult = flowOperationHelper.verifyAndGetFlowEntry(processDefinitionKey);
//        if (!flowEntryResult.isSuccess()) {
//            return Response.error(flowEntryResult.getCode(), flowEntryResult.getMsg());
//        }
//        // 2. 验证流程一个用户任务的合法性。
...
//        }
//        Response<TaskInfoVo> taskInfoResult =
...
//            return ResponseResult.errorFrom(datasourceResult);
//        }
//        Response assigneeVerifyResult = flowApiService.verifyAssigneeOrCandidateAndClaim(task);
