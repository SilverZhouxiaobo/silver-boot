package cn.silver.framework.common.utils.poi;
...
public class ExcelUtil<T> {
    ...
    public Response<String> exportExcel(List<T> list, String sheetName, HttpServletResponse response) {
        this.init(list, sheetName, Excel.Type.EXPORT);
        return exportExcel(response);
    }

    public Response<String> importTemplate(String sheetName, HttpServletResponse response) {
     ...
     * @return 结果
     */
    public Response<String> exportExcel(HttpServletResponse response) {
        OutputStream out = null;
        try {
            // 取出一共有多少个sheet.
            double sheetNo = Math.ceil(list.size() / sheetSize);
