...
public class DirectExchangeConfig {
    ...
    public DirectExchange directExchange() {
        DirectExchange directExchange = new DirectExchange("framework-direct");
        return directExchange;
    }

    @Bean
    public Queue directQueue1() {
        Queue queue = new Queue("framework.direct.queue1");
        return queue;
    }

    @Bean
    public Queue directQueue2() {
        Queue queue = new Queue("framework.direct.queue2");
        return queue;
    }
