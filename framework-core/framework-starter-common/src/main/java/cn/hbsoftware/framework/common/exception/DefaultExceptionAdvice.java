package cn.hbsoftware.framework.common.exception;
...
public class DefaultExceptionAdvice {
     ...
     */
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ExceptionHandler(com.central.common.exception.BusinessException.class)
    public Result handleException(com.central.common.exception.BusinessException e) {
