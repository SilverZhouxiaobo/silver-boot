package cn.silver.framework.security.service;
...
//        DateUtils.addMinutes(new Date(),20).before(loginUser.getExpireTime())
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        loginUser.setExpireTime(DateUtils.addMinutes(new Date(), expireTime));
        // 根据uuid将loginUser缓存
