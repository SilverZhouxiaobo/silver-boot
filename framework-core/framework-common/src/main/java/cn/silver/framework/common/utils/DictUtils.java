...
public class DictUtils {
     ...
     */
    public static void setDictCache(String key, List<DictModel> dictDatas) {
     ...
     */
    public static List<DictModel> getDictCache(String key) {
    ...
    public static String getDictLabel(String dictType, String dictValue, String separator) {
        ...
        List<DictModel> datas = getDictCache(dictType);

        if (StringUtils.containsAny(separator, dictValue) && StringUtils.isNotEmpty(datas)) {
            for (DictModel dict : datas) {
