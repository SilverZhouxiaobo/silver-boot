package cn.silver.framework.monitor.manager.factory;
...
import cn.silver.framework.common.utils.ip.AddressUtils;
...
import cn.silver.framework.monitor.LogUtils;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 插入数据
                SpringUtils.getBean(ISysBaseApi.class).insertLogininfor(logininfor);
            }
        };
    }
    ...
    public static TimerTask recordOper(final OperLog operLog) {
        return new TimerTask() {
            ...
            public void run() {
                ...
                SpringUtils.getBean(ISysBaseApi.class).insertOperlog(operLog);
            }
        };
    }
}
